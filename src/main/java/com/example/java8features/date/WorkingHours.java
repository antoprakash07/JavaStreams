...
public class WorkingHours {
    ...
    // Constructor
    public WorkingHours(Date startDate) {
    ...
    public void calculateEndDate(long milliseconds) {
        ...
        while (milliseconds > 0) {
            // Add milliseconds in chunks of hours or minutes for efficiency
    ...
    public static long convertToMilliseconds(int days, int hours, int minutes) {
        ...
        long totalMilliseconds = (days * millisInADay) + (hours * millisInAnHour) + (minutes * millisInAMinute);
    ...
    public static void main(String[] args) {
        ...
        // Example usage
        Calendar calendar = Calendar.getInstance();
        calendar.set(2024, Calendar.JULY, 13); // Set the start date (a weekend)
        WorkingHours workingHoursInstance = new WorkingHours(calendar.getTime());

        // Add holidays
        calendar.set(2024, Calendar.JULY, 15); // Example holiday
        WorkingHours.addHoliday(calendar.getTime());
